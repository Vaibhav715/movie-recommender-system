...
/* Updated Trailer Section Height for Better Aspect Ratio */
.trailer-section {
    position: relative;
    width: 100%;
    height: 450px; 
...
if page == "Recommend Movies":
    ...
    if not movies_df.empty:
        ...
        st.error("Dataset not found. Please ensure 'movie_dict.pkl' and 'similarity.pkl' are in the directory.")
        ...
        with st.container():
            ...
            with col2:
                ...
                if m['trailer_id']:
                    ...
                    # Height in iframe set to 450 to match container
                    st.markdown(f'''
                        <div class="trailer-section">
                            <div class="trailer-overlay">HOVER TO UNMUTE & PLAY</div>
                            <iframe src="{t_url}" width="100%" height="450" frameborder="0" allow="autoplay; encrypted-media"></iframe>
                        </div>
                    ''', unsafe_allow_html=True)
